...
'''
 1 In our first layer we will use linear regression methods ->
 ...
 2 Finally , in output layer we will use activation function - softmax(x)
'''
...
# we have image 28x28 pixels that we will transorm into matrices
# 0 -> completely black
...
data = pd.read_csv("C:/datasets/train.csv")
